...
// Scancodes below KEY_DOWN_END
// are key pressed scancodes
#define KEY_DOWN_END 	0x80

// Scancodes between KEY_DOWN_END and KEY_UP_END
// are key released scancodes
#define KEY_UP_END		0xD9
